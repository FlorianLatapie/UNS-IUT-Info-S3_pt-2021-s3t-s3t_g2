...
public class ConfigPartiePane extends StackPane {
	...
	public ConfigPartiePane(ScreenControl sc) {
		...
		couleur1.setMinSize(150, hauteurElemtents);
		// couleur1.getItems().addAll(DataControl.couleursPerso //ToDo);
		Label lBot1 = new Label("Bot ");
		lBot1.setFont(policeNom);
		lBot1.setBackground(fondBlanc);
		...
		j1.getChildren().addAll(nom1, couleur1, lBot1, estBot1);
		j1.setDisable(false);
		...
		couleur2.setMinSize(150, hauteurElemtents);
		// couleur2.getItems().addAll(DataControl.couleursPerso //ToDo);
		Label lBot2 = new Label("Bot ");
		lBot2.setFont(policeNom);
		lBot2.setBackground(fondBlanc);
		...
		j2.getChildren().addAll(nom2, couleur2, lBot2, estBot2);
		j2.setDisable(false);
		...
		couleur3.setMinSize(150, hauteurElemtents);
		// couleur3.getItems().addAll(DataControl.couleursPerso //ToDo);
		Label lBot3 = new Label("Bot ");
		lBot3.setFont(policeNom);
		lBot3.setBackground(fondBlanc);
		...
		j3.getChildren().addAll(nom3, couleur3, lBot3, estBot3);
		j3.setDisable(false);
		...
		couleur4.setMinSize(150, hauteurElemtents);
		// couleur4.getItems().addAll(DataControl.couleursPerso //ToDo);
		Label lBot4 = new Label("Bot ");
		lBot4.setFont(policeNom);
		lBot4.setBackground(fondBlanc);
		...
		j4.getChildren().addAll(nom4, couleur4, lBot4, estBot4);
		j4.setDisable(false);
		...
		couleur5.setMinSize(150, hauteurElemtents);
		// couleur5.getItems().addAll(DataControl.couleursPerso //ToDo);
		Label lBot5 = new Label("Bot ");
		lBot5.setFont(policeNom);
		lBot5.setBackground(fondBlanc);
		...
		j5.getChildren().addAll(nom5, couleur5, lBot5, estBot5);
		j5.setDisable(false);
		...
		couleur6.setMinSize(150, hauteurElemtents);
		// couleur6.getItems().addAll(DataControl.couleursPerso //ToDo);
		Label lBot6 = new Label("Bot ");
		lBot6.setFont(policeNom);
		lBot6.setBackground(fondBlanc);
		...
		j6.getChildren().addAll(nom6, couleur6, lBot6, estBot6);
		j6.setDisable(false);
