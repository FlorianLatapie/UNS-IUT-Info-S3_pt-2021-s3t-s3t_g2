...
public class UdpConnexion implements Runnable {
     ...
     *
     * @exception IOException Si l'interface ou si rejoindre le groupe est impossible
     */
    ...
    private void reception(DatagramPacket datagramPacket, String message) {
        ...
        controleurReseau.getTraitementPaquetUdp().traitement(PtOutils.strToPacketUdp(message, controleurReseau), message,
                datagramPacket);
    }
